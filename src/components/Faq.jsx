...
export default function Faq() {
  const faqs = [
    { q: "ما هي Visa الافتراضية؟", a: "هي بطاقة دفع إلكترونية لا تحتاج إلى بطاقة بلاستيكية فعلية، وتحتوي على بيانات يمكن استخدامها لدى الجهات التي تقبلها وفق شروط البطاقة." },
